...
<script>
    ...
    <div class="content" id="mydiv">
        <div class="row page-title-div">
            ...
            <div><button type="button" id="btnhid" class="btn btn-outline-info" style="position: absolute; top:60px; right:50px;"
                    onclick="hidebtn()"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
